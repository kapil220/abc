  ...
  return (
    <main className="bg-gradient-to-b from-[#E6DED7] via-[#F8F4EF] to-gray-100">
      <div className="max-w-5xl mx-auto px-4 py-36 space-y-24">
        ...
        >
          <h1 className="text-6xl  text-taupe font-heading" >About us</h1>
          <p className="text-2xl text-taupe/80 max-w-3xl mx-auto leading-relaxed font-subheading">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          >
            <div className="space-y-4">
              <h2 className="text-4xl  text-taupe font-bold font-subheading">Our Philosophy</h2>
              <p className="text-md  font-body text-taupe/80 leading-relaxed ">
            ...
            <div className="space-y-4">
              <h2 className="text-4xl  text-taupe font-bold font-subheading">Our Team</h2>
              <p className="text-md  font-body text-taupe/80 leading-relaxed">
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-subheeading font-bold text-taupe">
                      {feature.title}
                    </h3>
                    <p className="text-taupe/80 font-body">
                      {feature.description}
                    </p>
                  </div>
                </div>
        ...
        <motion.section 
          {...fadeIn}
          className="text-center max-w-3xl mx-auto space-y-6 py-12"
        >
          <h2 className="text-4xl  text-taupe font-bold font-subheading">Our Commitment</h2>
          <p className="ext-md  font-body text-taupe/80 leading-relaxed">
          ...
          <p className="text-xl font-bold text-taupe font-subheading pt-12">
