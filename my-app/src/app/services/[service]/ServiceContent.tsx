      ...
      <div className="max-w-7xl mx-auto px-8 py-24">
        ...
        >
          <div className="p-6 rounded-3xl  bg-white shadow-xl">
            <p className="text-md leading-relaxed text-taupe/80 text-justify font-body ">
      ...
      >
        ...
        >
          <div className="flex flex-col items-center gap-2">
            ...
            <p className="text-md  font-body text-center md:text-justify  text-taupe/80">{item.description}</p>
          </div>
        </motion.div>
      </motion.div>
    ))}
        ...
        >
          <div className="relative p-1 rounded-2xl overflow-hidden">
            ...
            <div className="relative p-12 bg-white rounded-2xl">
              <p className="text-md font-body  text-justify md:text-center text-taupe/80 mb-10 max-w-3xl mx-auto">
